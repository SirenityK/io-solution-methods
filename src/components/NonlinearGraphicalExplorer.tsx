                                ...
                                <span
                                    ...
                                    style={{
                                        "background-color":
                                            nonlinearPlotLineColors[
                                                constraintIndex %
                                                    nonlinearPlotLineColors.length
                                            ],
                                    }}
                                />
                                R{constraintIndex + 1}:{" "}
                                {
                                    props.solution.constraints[constraintIndex]
                                        .label
                                }
                            </div>
                        )}
                ...
                >
                    <Show
                        ...
                        fallback={
                            <>
                                <h2 class="card-title">
                                    Candidatos y función objetivo
                                </h2>
                                <p>
                                    Se evalúa cada candidato en la función
                                    objetivo y se compara el valor de Z.
                                </p>
                                <div class="overflow-x-auto rounded-box border border-base-300">
                                    <table class="table table-xs min-w-max sm:table-sm">
                                        ...
                                        <tbody>
                                            <For
                                                each={props.solution.candidates}
                                            >
                                                {(candidate) => (
                                                    <tr
                                                        class={
                                        ...
                                        <div class="alert alert-success alert-soft">
                                            <div class="space-y-3">
                                                <p class="font-semibold text-lg">
                                                    El {optimum().boundName} se
                                                    obtiene en el candidato{" "}
                                                    {optimum()
                                                        .points.map(
                                                            (point) =>
                                                                point.name,
                    ...
                    >
                        {(() => {
                            const constraint =
                                props.solution.constraints[
                                    props.currentStep - 1
                                ];
                            return (
                                <>
                                    <h2 class="card-title">
                                        Restricción {props.currentStep}
                                    </h2>
                                    <Katex
                                        displayMode
                                        math={latexConstraint(
                                    ...
                                    <p>
                                        La frontera se obtiene cambiando la
                                        relación por igualdad:
                                    </p>
                                    <Katex
                                        displayMode
                                    ...
                                    <Show
                                        when={
                                            constraint.axisIntersections
                                                .length > 0
                                        }
                                    >
                                        <div class="rounded-box border border-base-300 bg-base-200/70 p-3">
                                            <p class="font-semibold">
                                                Interceptos con ejes
                                            </p>
                                            <p class="text-base-content/75 text-sm">
                                                Para encontrarlos se fija una
                                                variable en cero y se resuelve
...
export const NonlinearGraphicalExplorer = () => {
    ...
    const currentPlotState = createMemo(
        () =>
            solutionState().solution?.plotStates[
                Math.min(selectedStep(), maxStep())
            ],
    );
                ...
                <div class="min-w-0 space-y-4">
                    <div class="rounded-box bg-linear-to-br from-accent/10 via-base-200 to-secondary/10 p-6">
                        ...
                        <p class="mt-3 max-w-3xl text-base-content/75">
                            Se dibujan rectas y curvas, se revisan
                            intersecciones, tangencias e interceptos, y se
                            evalúa la función objetivo paso a paso.
                        </p>
                    </div>
                    <ProblemEditor
                        problem={problem()}
                        ...
                        onReset={() =>
                            changeProblem(cloneProblem(exampleProblem))
                        }
                    />
                    <Show
                    ...
                    >
                        <Plot
                            solution={
                                solutionState()
                                    .solution as NonlinearProgramSolution
                            }
